...
public:
	...
	Lambertian(const glm::vec3& albedo) : IMaterial(albedo)
	{
	}
	...
	{
		glm::vec3 scatteredRayDirection = Random::UnitSphereWithOnHemisphereCheck(rayCollisionData.worldNormal) + Random::RandomUnitVector();
